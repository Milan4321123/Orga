...
(function () {
  ...
  var PATHS = {
    ...
    phone: '<path d="M7.2 3.5H4.9A1.9 1.9 0 0 0 3 5.6C3 13.4 10.6 21 18.4 21a1.9 1.9 0 0 0 2.1-1.9v-2.3a1.3 1.3 0 0 0-1.1-1.3l-3-.5a1.3 1.3 0 0 0-1.3.6l-.8 1.3a12.6 12.6 0 0 1-5.2-5.2l1.3-.8a1.3 1.3 0 0 0 .6-1.3l-.5-3a1.3 1.3 0 0 0-1.3-1.1Z"/>',
